...
export default class fileUploadImprovedCPE extends LightningElement {
    ...
    advancedConfiguration = [
        ...
        {label: 'Set ShareType to Inferred', helpText: 'By default, a ContentDocumentLink is created with the ShareType set to \'V\' (Viewer). If you\'d like to set the ShareType to \'I\' (Inferred), set this to TRUE.'},
    ...
    @track inputValues = {
        ...
        shareTypeInferred: { value: null, valueDataType: null, isCollection: false, label: 'Set ShareType to Inferred' },
        cb_shareTypeInferred: { value: null, valueDataType: null, isCollection: false, label: '' },
